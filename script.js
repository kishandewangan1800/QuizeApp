...
function loadQuestion() {
  ...
  queEle.innerText = currentQuizData.question;
...
function deselectAnswer() {
  ansEle.forEach((answerEl) => (answerEl.checked = false));
}
...
submitButton.addEventListener("click", () => {
  ...
  if (ans) {
    ...
    if (currentQuestion < quizData.length) {
      ...
      quiz.innerHTML = `<h2> you ${score}/${quizData.length} question currectly </h2>
